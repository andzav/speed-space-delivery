var pages = {
    admin: ["index.html", "log-in.html", "order.html", "planets.html", "ships.html", "sing-up.html", "tfa.html", "users.html", "main_user_page.html", "containers.html"],
    operator: ["index.html", "log-in.html", "order.html", "planets.html", "ships.html", "sing-up.html", "tfa.html", "main_user_page.html", "containers.html"],
...
function loadPageByPerm(perm) {
    ...
    accessPage.forEach(function (value, index) {
        if (fileName === value && perm = 'admin') pr = true;
        console.log(value);
    })
    if (!pr) {
        window.stop();
